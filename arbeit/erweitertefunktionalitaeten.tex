...
Mit diesen zwei Zeilen wird die Option \emph{Add to Homescreen} erlaubt und der Pfad zu einem Icon angegeben, welches dann auf dem Homescreen erscheinen soll.
