...
\ifpdf
    ...
    \hypersetup{%
      pdftitle={Installations- und Bedienungsanleitung für die Meißner Webanwendung}, %%%% HIER AENDERN!!!
      pdfsubject={},
      pdfauthor={Christian Meter},           %%%% HIER AENDERN!!!
      pdfkeywords={readme, instructions, meissner, app, linux, debian},      %%%% HIER AENDERN!!!
